 ...
 * @returns {(obj: { limit: number | string, offset: number | string, query: { match: string, term: string }}) => import('@elastic/elasticsearch').RequestParams.Search} A function that will generate the Search parameters.
 */
