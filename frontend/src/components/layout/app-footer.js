...
AppFooter.propTypes = {
  ...
  /**
   * Custom element type for this component (defaults to `footer`).
...
function AppFooter({ as: Component, className, style }) {
  return (
    <Component className={clsx(className, 'text-gray-700 body-font')}>
      <div className="container flex flex-col flex-wrap px-5 py-24 mx-auto md:items-center lg:items-start md:flex-row md:flex-nowrap">
        <div className="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
          <a className="flex items-center justify-center font-medium text-gray-900 title-font md:justify-start">
            <span className="ml-3 font-mono text-xl font-semibold">{'EQT'}</span>
          </a>
